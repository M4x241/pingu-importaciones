...
export default function ClientPage() {
  ...
  return (
    <div style={{ backgroundColor: '#0F172A', minHeight: '100vh' }}>
      <div className="w-full mx-auto !px-6 !py-8 !pt-28">
        ...
        <div className="!grid !grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 !gap-4 !mb-8">
          {[
            ...
            { icon: Truck, label: 'Total Gastado', value: '$' + totalGastado.toFixed(2), color: '#8B5CF6' },
          ].map((stat, i) => (
        ...
        <div className="rounded-2xl p-6" style={{ background: 'rgba(255, 255, 255, 0.04)', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
          <div className="flex items-center justify-between !mb-6">
            <h3 className="text-lg font-bold text-white">Mis Reservaciones</h3>
                  ...
                  {reservaciones.map((res) => {
                    ...
                    return (
                      <tr key={res.id} className="!border-t" style={{ borderColor: 'rgba(255, 255, 255, 0.06)' }}>
                        <td className="py-4 text-white font-mono text-xs">{res.codigo_unico}</td>
                        <td className="py-4 text-slate">{new Date(res.fecha_reservacion).toLocaleDateString()}</td>
                        <td className="py-4 text-slate hidden md:table-cell max-w-[200px] truncate">{nombres}</td>
        ...
        <div className="!grid !grid-cols-1 sm:grid-cols-3 !gap-4 !mt-8">
          <Link to="/tienda"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">Explorar Tienda</p>
          ...
          <Link to="/"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">Inicio</p>
