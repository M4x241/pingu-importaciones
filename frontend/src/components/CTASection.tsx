    ...
    return (
        ...
        >
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10 space-y-8">
                ...
                <p className="text-lg md:text-xl max-w-2xl mx-auto leading-relaxed" style={{ color: 'rgba(203, 213, 225, 0.6)' }}>
                    Cada día se abren nuevos grupos de importación. No dejes pasar la oportunidad de importar
                    seguro, confiable y <strong className="text-white">al mejor precio del mercado</strong>.
                </p>
                ...
                {/* Trust line */}
                <p className="text-sm pt-4" style={{ color: 'rgba(203, 213, 225, 0.4)' }}>
